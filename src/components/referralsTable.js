...
const ReferralsTable = (props) => {
  ...
  return (
    referrals && (
      ...
      >
        <h1 className="text-xl font-bold text-gray-800 mb-4">All referrals</h1>
        ...
        <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 items-center justify-between mt-4 text-sm text-gray-600">
          <p>
            {currentRows.length > 0

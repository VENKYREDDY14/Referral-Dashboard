    ...
    <>
      <section className="flex h-screen items-center justify-center bg-gray-100">
        <div className="w-full max-w-sm bg-white rounded-lg shadow-md p-8">
          <h1 className="text-3xl font-bold text-blue-500 mb-2">Go Business</h1>
          ...
          <form className="space-y-4" onSubmit={handleSubmitLogin}>
            <div>
              ...
              <input
                ...
                className="mt-1 w-full px-3 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-blue-400"
              />
            </div>
